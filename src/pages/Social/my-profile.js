...
class MyProfile extends PureComponent {
  ...
  getData = async () => {
    ...
    try {
      ...
      const newData = response.data.filter(t => t.user_id === accountInfo.id);
      let listImage = [];
  ...
  render() {
    ...
    const {data, listImage} = this.state;
    return (
        ...
        <ScrollView
            ...
            <View style={{marginTop: dvWidth / 3, alignItems: 'center'}}>
              ...
              <View
                ...
                <TouchableOpacity style={{alignItems: 'center', flex: 1}}>
                  ...
                  <Text style={{color: '#a7a9bc'}}>Bài đăng</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{alignItems: 'center', flex: 1}}>
                  <Text
                    style={{
                  ...
                  <Text style={{color: '#a7a9bc'}}>Ảnh</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
            ...
            <View>
              <View style={{flexDirection: 'row', marginTop: 8}}>
                ...
                <Text style={{padding: 4}}>
                  {accountInfo.address || 'Chưa cập nhật'}
                </Text>
              </View>
              <View style={{flexDirection: 'row', marginTop: 8}}>
                <Icon
                ...
                />
                <Text style={{padding: 4}}>
                  {accountInfo.email || 'Chưa cập nhật'}
                </Text>
              </View>
              <View style={{flexDirection: 'row', marginTop: 8}}>
                <Icon
                ...
                />
                <Text style={{padding: 4}}>
                  {accountInfo.phone || 'Chưa cập nhật'}
                </Text>
              </View>
            </View>
          </View>
          <View style={{paddingHorizontal: 16}}>
            <View style={{flexDirection: 'row'}}>
              ...
              {listImage?.filter(v => !v.empty).length > 6 ? (
                <TouchableOpacity
                  onPress={() =>
                    navigation.navigate('AlbumAll', {
                      data: listImage,
